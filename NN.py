...
"""
def create_NN(col, domain, batch_size, learning_rate, activation_function, hidden_layer_width):
    if domain == 'mnist':
        input_size = col
    elif domain == 'circles':
        input_size = col
    ...
    return NN(col, batch_size, iterations, learning_rate, layer_sizes, activation_func=input_activation_func, 
...
class NN ():
    ...
    def __init__ (self, col, batch_size, iterations, learning_rate, sizes = [], activation_func = None, 
        ...
        '''
        #self.weights = np.array([1.0/col for i in range(col)]);
